...
<h5 class="mt-5">tambah pesan</h5>

<div class="row">
    <div class="col-lg-6" id="collapseExample">      
                ...
                <div class="mr-2" style="font-size:14px;float:left;">
                    <?php 
                        if (empty($user->foto)){
                            ...
                            echo "<img class='rounded-circle' src='".base_url("uploads/" .$user->foto)."' width='50' />";
                        }
                    ?>
                </div>
                <div class="ml-5">
                    <a href="javascript:;" data-friend="<?php echo $user->user_id ?>"><?php echo $user->username ?> </a>
                    <a href="<?php echo site_url ('profil_member/profil/'. $user->user_id); ?>" class="btn btn-outline-info btn-sm float-right">Profil </a> 
                    
                    <br>
                    <span style="font-size:11px;"><?php echo $user->name ?></span>
