...
<!-- akhir modal hapus     -->
    ...
    <tbody>
        ...
        <td>
        <a class="linkviewtip" title="Go to: <?php echo $post->title; ?>" href="<?php echo site_url('thread/talk/'.$post->th_slug); ?>"><?php echo $post->title; ?></a>
        </td>
        <td>
           <a href="<?php echo site_url('chat/profil/'.$post->user_id); ?>"> <?php echo $post->username; ?></a>
        </td>
        ...
        <td style="text-align: center;"><a title="delete" class="del btn btn-danger btn-sm" data-target="#modalConfirm" id="post_id_<?php echo $post->post_id; ?>" href="<?php echo site_url('admin/post_delete').'/'.$post->post_id;?>">Hapus</a></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
